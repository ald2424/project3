...
function HomePage(){
    return (
        <div className="px-5">
                        ...
                        <p className="p-5 m-auto">Shea Rose Farm was established in 1988 and for over 30 years has been providing a valuable service to the South Charlotte area.
                            <br></br>
                            ...
                            <br></br>
                            At Shea Rose Farm, we seek to glorify God in all that we do and strive to provide an excellent, caring program with horses that are well attended. We are a family friendly farm and encourage visitors to come and check us out!</p>
                            <br></br>
        </div>
    )
}
